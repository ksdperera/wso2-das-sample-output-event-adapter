...
* under the License.
*/
package org.custom.event.output.adapter.email;


import org.wso2.carbon.event.output.adapter.core.*;
import org.custom.event.output.adapter.email.internal.util.EmailEventAdapterConstants;
...
public class EmailEventAdapterFactory extends OutputEventAdapterFactory {
    private ResourceBundle resourceBundle =
            ResourceBundle.getBundle("org.custom.event.output.adapter.email.i18n.Resources", Locale.getDefault());
